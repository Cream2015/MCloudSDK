using MCloudSDK.QCloud.Cos.SDK.Api;
using MCloudSDK.QCloud.Cos.SDK.Common;
using System;
using System.Collections.Generic;

namespace MCloudSDK.QCloud.Cos.SDK.Test
{
    public class Program
    {
        const int APP_ID = 12306;//Your AppID
        const string SECRET_ID = "Your SecretID";
        const string SECRET_KEY = "Your SecretKEY";
        static void Main(string[] args)
        {
            try
            {
                ...
                //本地路径
                const string localPath = @"D:\test.jpg";

                //远程路径，可理解为文件名
                const string remotePath = "test.jpg";
